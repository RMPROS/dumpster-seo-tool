...
function buildSeoModelSheet(sheet: ExcelJS.Worksheet, result: ResearchResult, proj: ReturnType<typeof buildProjectionData>) {
  ...
  const rows = [
    ...
    { label: 'Organic CTR (from CTR Tables)', current: {1:0.398,2:0.187,3:0.102,4:0.072,5:0.051,6:0.040,7:0.030,8:0.020,9:0.015,10:0.010}[proj.currentOrgRank as keyof typeof {1:number}] || 0, target: 0.398, fmt: '0.0%' },
